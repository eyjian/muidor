 ...
 */
#ifndef MOOON_UIDOR_H
#define MOOON_UIDOR_H
...
public:
    ...
    CUidor(const std::string& agent_nodes, uint32_t timeout_milliseconds=300, uint8_t retry_times=3, bool polling=false) throw (utils::CException);
    ~CUidor();
